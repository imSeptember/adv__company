...
if (sliderLine && prevButton && nextButton) {
  const theNextSlide = () => {
...
if (firstButtonDivorce && secondButtonDivorce && thirdButtonDivorce) {
...
if (firstSlideDivorce && secondSlideDivorce && thirdSlideDivorce) {
